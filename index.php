...
// ----------------------------------------------------------------------------
// LOAD CONFIGURATION
Config::init('microstatic/config/env.php', __DIR__);
...
Router::fetch(function() {
    ...
    Router::get('seo-tutorial-1', function () {
        return buffer('microstatic/modules/seo-tutorial-1/index.php');
    });
    ...
    Router::get('welcome/(:any)/(:any)',
        'Acme\\Controllers\\YourController@yourMethod');
